onload=function(){
  ...
  var welcomeState = function(game){
    ...
    this.create=function(){
      ...
      startText=game.add.text(game.world.centerX,game.world.centerY,'璐璐特供，点击开始!',{fill:'#fff',fontSize:'16px'});
  ...
  var gameoverState = function(game){
    this.create=function(){
      ...
      restartText=game.add.text(game.world.centerX,game.world.centerY,'璐璐特供，点击开始!',{fill:'#fff',fontSize:'16px'});
